...
public class TesteUniao {
    ...
    public static void main(String[] args) {
        ...
        conjunto1.adicionarElemento(new Elemento(12));
        conjunto1.adicionarElemento(new Elemento(13));
        conjunto1.adicionarElemento(new Elemento(14));
        ...
        conjunto2.adicionarElemento(new Elemento(8));
        conjunto2.adicionarElemento(new Elemento(9));
        conjunto2.adicionarElemento(new Elemento(10));
        conjunto2.adicionarElemento(new Elemento(11));
